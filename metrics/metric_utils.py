...
#----------------------------------------------------------------------------
class MetricOptions:
    def __init__(self, G=None, G_kwargs={}, dataset_kwargs={}, num_gpus=1, rank=0, device=None, progress=None, cache=True, train_mask_path=None, val_mask_path=None):
        ...
        self.cache          = cache
        self.train_mask_path = train_mask_path  # 添加 train_mask_path 属性
        self.val_mask_path = val_mask_path  # 添加 val_mask_path 属性
